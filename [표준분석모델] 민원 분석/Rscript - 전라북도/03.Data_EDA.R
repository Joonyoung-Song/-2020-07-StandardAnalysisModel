...
# 연도별-월별 라인 그래프 생성
plot(freq_all_DT, type = "l", las = 2, col = "lightblue", main = "연도별-월별 민원 빈도 Line Chart")
imagedir <- paste("C:/Users/Admin/Desktop/민원분석/result/01.EDA/", substr(Sys.Date(), 1, 4), sep="")
